...
>密码学是研究编制密码和破译密码的技术科学。研究密码变化的客观规律，应用于编制密码以保守通信秘密的，称为编码学；应用于破译密码以获取通信情报的，称为破译学，总称密码学。    ——百度百科-密码学

为了更好的理解区块链，本文简单介绍几种常见的密码学历史和概念，其中包括对称密码，非对称密码，哈希函数，数字签名，数字认证等，需要特殊说明的是并不深入探讨每种加密算法原理。只引导读者对密码学整个整体的概念，至于每种具体的算法的原理与简单实现，我后续会一一阐述。
...
本文主要阐述了密码学中的<font color=#00ffff>对称密码和哈希密码</font>，在[《一万字带您走进密码学的世界（下）》](cryptology1.html)的文章中我们将继续介绍 非对称密码，秘钥交换，数字证书等概念。
