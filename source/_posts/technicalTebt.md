...
软件工程实际大部分都是研究方法论，它是一门非常宏观的课程，3年前我觉得这些都是在浪费时间，做了多年开发之后才能真正理解其中的痛楚，有些前人总结的方法和教训我们还是要注意的。不能等初亏了之后再回头。

今天在英国做的一个技术债务的分享，其中拿了阿里巴巴的数据库做了案例分析，其中的有些数据可能不够准确，毕竟之前没在阿里工作过，但是不影响对其中的讲解。下面引用维基百科技术负债的定义开始本文的分享。
...
阿里巴巴集团（英语：Alibaba Group），（NYSE：BABA）创立于1999年，是一间提供电子商务在线交易平台的公司，业务包括B2B贸易、网上零售、购物搜索引擎、第三方支付和云计算服务。集团的子公司及关系公司有阿里巴巴B2B[3]、淘宝网、天猫、一淘网、阿里云计算及支付宝。旗下的淘宝网和天猫在2012年销售额达到1.1万亿人民币，超过亚马逊公司和eBay之和。其2015年度商品交易总额已经超过3万亿元人民币，是全球最大零售商[4]。
...
### 日益增长的运维费用
在这里举了一个简单的例子，我们想查询一个用户的用户信息从一个简单的表中，如果数据量只有1000条，那么在执行的时候就非常简单。
...
支付宝于2004年末发布，实际在这个时候阿里巴巴几乎完成数据往oracle的迁移。实际他们已经意识到了MYSQL数据库的安全问题，oracle在当时提供了完美的安全解决方案，成了当时支付宝能迅速崛起的一个重要支撑。
...
最后总结一下今天所讲的东西，开始引入技术债务概念，简单介绍介绍下阿里巴巴，重点讲解了技术债务和数据库架构变更之间的关系，最后举出了技术债务的分类在实际项目的应用。
